...
export default {
  ...
  'company.tencent.project.inquiry.name': '合约广告询量下单系统',
  ...
  'company.baidu.project.landing.duty.2': '使用 React + Redux 开发',
