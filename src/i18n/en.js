...
export default {
  ...
  'company.alibaba.project.teambition.duty.1':
    'Responsible for team monitoring infrastructure construction, monitoring SDK design and development',
  'company.alibaba.project.teambition.duty.2':
    "Monitoring SDK implements API abstract layer which is transparent for SDK users, and is able to multiple writing. Extended functions are scaled by plugins, such as 'FMP', 'Dropped frame detection', 'Global uncaught promise handler', etc.",
  'company.alibaba.project.teambition.duty.3':
    'Optimize Dingtalk login performance.',
  ...
  'company.alibaba.project.aliyundrive.duty.2':
    'Refactor client core module of file transfer by RxJs, time slicing rendering, lead to rendering performance optimization in a huge amount of file transfer scenario.',
  'company.tencent.name': 'Tencent',
  'company.tencent.rank': 'Senior Front End Engineer (T9)',
  'company.tencent.desc':
    "Tencent Contract Advertisement team front-end tech leader.\r\nResponsible for the team's infrastructure construction, development principles, architecture evolution, and requirement outline design, etc, as well as the implementation of requirements.",
  'company.tencent.project.inquiry.name':
    'Contract Advertising Inquiry and Order Platform',
  'company.tencent.project.inquiry.desc':
    'Sellers could inquiry about future advertisement inventory and reserve and replenish inventory. \r\nThe original platform is a legacy project(10 years old). Developed by vanilla js, it has many problems. For example, the platform uses a non-standard module, no modern bundler, and the front-end, back-end is not separated. \r\nAnd the business logic is complicated because of thousands of advertising forms. So it is hard to maintain and evolve.',
  ...
  'company.tencent.project.inquiry.duty.2':
    'Automatic deployment: manually call PHP API to bundle js, and upload the output to git repo to deploy, upgrade to build, deploy automatically by CI/CD',
  'company.tencent.project.inquiry.duty.3':
    'Frameworks upgrade: Rewrite partial components by Vue.js, making codebases more maintainable and extensible',
  ...
  'company.tencent.project.inquiry.duty.5':
    'Non-intrusive refactoring: convert normal events to RxJS observable stream to deal with complex form fields linkage and the asynchronous race problem',
  ...
  'company.tencent.threeone.desc':
    'Integrate three out-of-date advertising platforms (advertisement inventory, order, and delivery platform) into one complete, large-scale platform which provides one-stop services: sellers could inquiry, reserve, order, replenish at the platform.\r\nTech stack: Vue2 + vue-composition-api, Nuxt.js, RxJS, InversifyJS, lerna.',
  'company.tencent.threeone.duty.1':
    'Build the entire architecture from scratch to launch, lead 4 front-end developers, and contribute 70% of the code at the early stage of the project, released initial version in three months',
  'company.tencent.threeone.duty.2':
    'Responsible for making team development principles, designing Git workflow, reviewing design and requirements, code review, CI/CD deployment, etc',
  'company.tencent.threeone.duty.3':
    'Abstract basic modules with nuxt.js and vue-composition-api, including a configurable router, permission management, SSR pre-fetch component, API requester, mock middleware, etc',
  'company.tencent.threeone.duty.4':
    'Core modules(form and detail pages) are built with IoC, headless components(like formik), and using RxJS to deal with complex form linkage',
  ...
  'company.baidu.project.dsp.desc':
    'The only DSP platform in WangMeng department, with an average daily consumption of five million RMB. It is a one-stop delivery platform, which provides the advertiser with programmed advertising purchase services.\r\nTech stack: jQuery, ER(MVC framework in Baidu), Edp(like gulp).',
  ...
  'company.baidu.project.landing.duty.3':
    'Design JSON schema which describes rendering logic of landing page. Render engine render consistent elements both in online maker and landing page',
  ...
  'company.baidu.project.nichang.duty.1':
    'Key developer, responsible for most requirements and code refactoring.',
  ...
  'skills.title': 'Skills',
  'skills.1':
    'Experience in developing large-scale projects from scratch to launch, especially architecture design, framework selection',
  'skills.2':
  ...
  'skills.5':
    'Understand React，can build large-scale projects on my own, also understand other frameworks like Angular, Svelte',
  'skills.6':
